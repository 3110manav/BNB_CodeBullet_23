...
import animalData from "../constant/data.json";
  ...
  return (
    <>
      ...
      items-center min-h-screen "
        >
          <div
            className="h-full absolute top-0 right-0 left-0 z-0 opacity-20"
            style={{
          ...
          <div className="lg:w-3/4 xl:w-2/4 relative z-10 h-100 lg:mt-16">
            <div>
              ...
              <p className="text-blue-100 text-xl md:text-2xl leading-snug mt-4">
                Welcome to our platform dedicated to animal awareness and
                conservation.
              </p>
              <Link
                to="/park"
        ...
        <div className="flex flex-col lg:flex-row lg:-mx-8">
          <div className="w-full lg:w-1/2 lg:px-8">
            ...
            <p className="mt-2 leading-relaxed">
              We strive to raise awareness about endangered species, advocate
              for their protection, and conserve natural habitats to ensure a
              sustainable future for all life forms on our planet.
            </p>
          </div>
          ...
          <div className="w-full lg:w-1/2 lg:px-8 mt-12 lg:mt-0">
            <div className="md:flex">
              ...
              <div className="md:ml-8 mt-4 md:mt-0">
                ...
                <p className="mt-2 leading-relaxed">
                  We work closely with local communities, partner organizations,
                  and government agencies to implement conservation projects,
                  conduct research, and educate the public about the importance
                  of biodiversity and ecosystem preservation.
                </p>
              </div>
            </div>
            ...
            <div className="md:flex mt-8">
              ...
              <div className="md:ml-8 mt-4 md:mt-0">
                ...
                <p className="mt-2 leading-relaxed">
                  Together, we can make a difference. Join our community,
                  volunteer for conservation efforts, or donate to support our
                  cause. Every action counts in the fight to protect and
        ...
        <div className="md:flex md:flex-wrap mt-24 text-center md:-mx-4">
          <div className="md:w-2/3 md:px-4 lg:w-1/3">
            <div className="bg-white rounded-lg border border-gray-300 pt-8 pr-6 pl-6 pb-12">
              ...
              <p className="mt-1">
                We educate people on how to we protect and restore natural
                habitats.
              </p>
          ...
          <div className="md:w-2/3 md:px-4 lg:w-1/3">
            <div className="bg-white rounded-lg border border-gray-300 pt-8 pr-6 pl-6 pb-12">
              ...
              <p className="mt-1">
                Education on how we can care for injured animals and orphaned
                animals.
              </p>
              <a href="#" className="block mt-4">
                Read More
          ...
          <div className="md:w-2/3 md:px-4 lg:w-1/3">
            <div className="bg-white rounded-lg border border-gray-300 pt-8 pr-6 pl-6 pb-12">
              ...
              <p className="mt-1">
                We educate people on how to take are and protect, restore
                natural wildlife .
              </p>
              <a href="#" className="block mt-4">
                Read More
      ...
      <section className="relative bg-gray-100 px-2 sm:px-6 lg:px-14 xl:px-38 2xl:px-64 py-16 lg:py-32">
        <div className="flex flex-col lg:flex-row lg:-mx-8">
          <div className="w-full lg:w-1/2 lg:px-8">
            ...
            <p className="mt-2 leading-relaxed">
              Wildlife conservation is crucial for maintaining ecological
              balance, preserving biodiversity, and ensuring the survival of
              future generations. By supporting conservation efforts, you
              contribute to the protection of endangered species and the
          ...
          <div className="w-full md:mx-auto lg:w-1/2 lg:px-8 mt:md-0">
            ...
            <p className="italic text-sm mt-2 text-center">
              "The wildlife and its habitat cannot speak, so we must and we
